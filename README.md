...
Кнопка `Ready 25к+` в админке парсит активные каналы из базы только за последние 24 часа.
Порог просмотров задаётся переменной `POST_MIN_VIEWS`, по умолчанию `25000`.
